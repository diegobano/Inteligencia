...
def new_fc_layer(input,  # Capa anterior.
                 ...
                 use_sigmoid=True):  # Decide si usar sigmoid o no.
...
layer_fc1 = new_fc_layer(input=layer_flat, num_inputs=num_features, num_outputs=fc_size, use_sigmoid=True)

layer_fc2 = new_fc_layer(input=layer_fc1, num_inputs=fc_size, num_outputs=num_classes, use_sigmoid=False)
